...
O CREA (Conselho Federal de Engenharia e Agronomia) é um conselho de fiscalização profissional responsável pela regulamentação das atividades de Engenharia no Brasil. Além de Engenharias, o CREA também regula outros cursos relacionados com TI como Técnologo em Redes de Computadores. Para que o profissional possa exercer qualquer atividade profissional com o título de "Engenheiro" ou qualquer outro título que faça parte das profissões reguladas pelo CREA como  "Engenheiro da Computação" ou "Engenheira de Software" precisa ser credenciado junto ao Conselho.

Ser registrado no CREA traz algumas proteções conquistadas pelo Conselho como Piso Salarial de oito sálarios mínimos para oito horas de trabalho, 
