...
Já os cursos livres, como o próprio nome sugere, são cursos que não possuem vínculo com nenhuma instituição reconhecida pelo MEC e não exigem requisitos específicos para o ingresso. Esses cursos são direcionados a pessoas que buscam aperfeiçoamento ou especialização em determinada área, sem a preocupação de obter uma certificação formal.
...
Por outro lado, os cursos livres podem ser uma boa opção para quem já tem uma formação universitária e deseja se aperfeiçoar em uma determinada área, mas eles não têm o mesmo valor reconhecido pelo mercado de trabalho que um diploma universitário.
